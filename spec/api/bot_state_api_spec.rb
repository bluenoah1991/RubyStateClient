...
# Unit tests for SwaggerClient::BotStateApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BotStateApi' do
  before do
    # run before each test
    @instance = SwaggerClient::BotStateApi.new
  end
  ...
  describe 'test an instance of BotStateApi' do
    it 'should create an instact of BotStateApi' do
      expect(@instance).to be_instance_of(SwaggerClient::BotStateApi)
    end
  end

  # unit tests for bot_state_delete_state_for_user
  # DeleteStateForUser
  ...
  # @return [Array<String>]
  describe 'bot_state_delete_state_for_user test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_get_conversation_data
  # GetConversationData
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_get_conversation_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_get_private_conversation_data
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_get_private_conversation_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_get_user_data
  # GetUserData
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_get_user_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_set_conversation_data
  # SetConversationData
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_set_conversation_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_set_private_conversation_data
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_set_private_conversation_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for bot_state_set_user_data
  # SetUserData
  ...
  # @param [Hash] opts the optional parameters
  # @return [BotData]
  describe 'bot_state_set_user_data test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
